...
def pir_search_true(
    ...
    """
    PIR търсене чрез хомоморфни изчисления
    """
            ...
            if v:
                final_results.append({
                    "vehicle": {
                        ...
                        "encrypted_metadata": r["encrypted_metadata"],  # ← ADD THIS
                    },
...
def get_all_vehicles(skip: int = 0, limit: int = 100) -> List[Vehicle]:
    """
    Връща всички криптирани записи
    """
    db = get_db()
    try:
        return (
...
def get_encryption_stats() -> Dict:
    ...
    plain_size = 256 * 4  # референтен размер (некриптиран embedding)

    return {
        "total_vehicles": stats["total_vehicles"],
        "plain_embedding_size_bytes": plain_size,
        "storage_overhead": stats["avg_encrypted_storage_bytes"] / plain_size
